...
const (
	Agent_GetVersion_FullMethodName       = "/khutulun.Agent/getVersion"
	Agent_ListHosts_FullMethodName        = "/khutulun.Agent/listHosts"
	Agent_AddHost_FullMethodName          = "/khutulun.Agent/addHost"
	Agent_ListNamespaces_FullMethodName   = "/khutulun.Agent/listNamespaces"
	Agent_ListPackages_FullMethodName     = "/khutulun.Agent/listPackages"
	Agent_ListPackageFiles_FullMethodName = "/khutulun.Agent/listPackageFiles"
	Agent_GetPackageFiles_FullMethodName  = "/khutulun.Agent/getPackageFiles"
	Agent_SetPackageFiles_FullMethodName  = "/khutulun.Agent/setPackageFiles"
	Agent_RemovePackage_FullMethodName    = "/khutulun.Agent/removePackage"
	Agent_DeployService_FullMethodName    = "/khutulun.Agent/deployService"
	Agent_ListResources_FullMethodName    = "/khutulun.Agent/listResources"
	Agent_Interact_FullMethodName         = "/khutulun.Agent/interact"
)
...
func (c *agentClient) GetVersion(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Version, error) {
	out := new(Version)
	err := c.cc.Invoke(ctx, Agent_GetVersion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) ListHosts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Agent_ListHostsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[0], Agent_ListHosts_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) AddHost(ctx context.Context, in *AddHost, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, Agent_AddHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) ListNamespaces(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Agent_ListNamespacesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[1], Agent_ListNamespaces_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) ListPackages(ctx context.Context, in *ListPackages, opts ...grpc.CallOption) (Agent_ListPackagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[2], Agent_ListPackages_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) ListPackageFiles(ctx context.Context, in *PackageIdentifier, opts ...grpc.CallOption) (Agent_ListPackageFilesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[3], Agent_ListPackageFiles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) GetPackageFiles(ctx context.Context, in *GetPackageFiles, opts ...grpc.CallOption) (Agent_GetPackageFilesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[4], Agent_GetPackageFiles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) SetPackageFiles(ctx context.Context, opts ...grpc.CallOption) (Agent_SetPackageFilesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[5], Agent_SetPackageFiles_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) RemovePackage(ctx context.Context, in *PackageIdentifier, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Agent_RemovePackage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) DeployService(ctx context.Context, in *DeployService, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Agent_DeployService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) ListResources(ctx context.Context, in *ListResources, opts ...grpc.CallOption) (Agent_ListResourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[6], Agent_ListResources_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) Interact(ctx context.Context, opts ...grpc.CallOption) (Agent_InteractClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[7], Agent_Interact_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Agent_AddHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_AddHost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Agent_RemovePackage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_RemovePackage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Agent_DeployService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_DeployService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	Delegate_ListResources_FullMethodName  = "/khutulun.Delegate/listResources"
	Delegate_ProcessService_FullMethodName = "/khutulun.Delegate/processService"
	Delegate_Interact_FullMethodName       = "/khutulun.Delegate/interact"
)
...
func (c *delegateClient) ListResources(ctx context.Context, in *DelegateListResources, opts ...grpc.CallOption) (Delegate_ListResourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Delegate_ServiceDesc.Streams[0], Delegate_ListResources_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *delegateClient) ProcessService(ctx context.Context, in *ProcessService, opts ...grpc.CallOption) (*ProcessServiceResult, error) {
	...
	err := c.cc.Invoke(ctx, Delegate_ProcessService_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *delegateClient) Interact(ctx context.Context, opts ...grpc.CallOption) (Delegate_InteractClient, error) {
	stream, err := c.cc.NewStream(ctx, &Delegate_ServiceDesc.Streams[1], Delegate_Interact_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Delegate_ProcessService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Delegate_ProcessService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
